...
- The Guess Game: 
In this game the computer generates a random integer number between 0 and 1000 and the user has to
guess this number in 10 turns with the help of the feedbacks he/she gets from the computer.
